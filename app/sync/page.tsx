    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4 p-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">Sync Unavailable</h1>
          <p className="text-muted-foreground">Data sync is only available on localhost.</p>
          <button onClick={() => router.push('/')} className="text-primary hover:underline text-sm">Back to Dashboard</button>
        </div>
      </div>
    )
  }
